...
void D3DApp::OnResize()
{
    ...
    CD3DX12_RESOURCE_BARRIER Resource_barrier = CD3DX12_RESOURCE_BARRIER::Transition(mDepthStencilBuffer.Get(),
        D3D12_RESOURCE_STATE_COMMON,
...
bool D3DApp::InitDirect3D()
{
    ...
    * 1. D3D12CreateDevice 함수를 이용해서 ID3D12Device를 생성한다. 
    ...
    /* ===================================================================
     * 2. 장치를 생성한 다음에는 CPU와 GPU의 동기화를 위한 울타리를 객체를 생성한다. 
  ...
  =================================================================== */
    ...
    //4.3.3 4X MSAA 지원여부를 점검한다.
    // 비용이 그리 크지 않으면서도 화질이 많이 개선된다는 점과 
